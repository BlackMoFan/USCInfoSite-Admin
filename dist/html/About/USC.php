<?php
    ...
    if(isset($_POST['upload'])) {
        ...
        $target1 = "./images/USC/".basename($_FILES['officer_portrait']['name']);
        ...
        // echo $_FILES['officer_portrait']['tmp_name'];
        // echo $msg;
    }
...
<html lang="en">
  <head>
    ...
    />
    <title>USC About Section - USC</title>
...
<body>
  ...
  <section id="new-usc-officer-screen">
    ...
    <form class="form-container" id="newusc-form-container" method="post" action="./USC.php" enctype="multipart/form-data">
  ...
  <main>
    <aside>
      <a class="sidebar-items active"><span>USC</span></a>
      <a class="sidebar-items" href="./SSG.php">
        <span>SSG</span>
      </a>
    ...
    <section id="usc-list">
      ...
      <section class="articles">
        ...
        <?php
                    // $db = mysqli_connect("localhost", "root", "", "uscbackend_db");
                    $sql = "SELECT * FROM officer WHERE officer_organization='USC'";
        ...
        <article class="article-items" href="">
          ...
          <img src="./images/USC/<?= $row['officer_portrait'] ?>" class="article-img" />
          <div class="article-info">
            ...
            <div class="article-actions">
              ...
              <!-- <form style="display: inline;" action="./USC.php" method="POST">
                  <button
                    id="delete-highlight"
                    type="submit"
                    name="delete_officer"
