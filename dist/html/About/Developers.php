<?php
    ...
    if(isset($_POST['upload'])) {
        ...
        $target1 = "./images/DEVELOPERS/".basename($_FILES['officer_portrait']['name']);
        ...
        $officer_organization = 'Developers';
...
<html lang="en">
  <head>
    ...
    />
    <title>USC About Section - Developers</title>
  </head>
</html>
<body>
  ...
  <section id="new-usc-officer-screen">
    ...
    <form class="form-container" id="newusc-form-container" method="post" action="./Developers.php" enctype="multipart/form-data">
  ...
  <main>
    ...
    <section id="usc-list">
      ...
      <section class="articles">
        ...
        <?php
                    // $db = mysqli_connect("localhost", "root", "", "uscbackend_db");
                    $sql = "SELECT * FROM officer WHERE officer_organization='Developers'";
        ...
        <article class="article-items" href="">
          ...
          <img src="./images/DEVELOPERS/<?= $row['officer_portrait'] ?>" class="article-img" />
                  ...
                  <div class="confirm-delete-container">
                    ...
                    <div class="confirm-delete-content">
                      ...
                      <div class="confirm-delete-btns">
                        <form style="display: inline;" action="./Developers.php" method="POST">
