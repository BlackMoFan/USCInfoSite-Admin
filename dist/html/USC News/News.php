<?php
    ...
    if(isset($_POST['upload'])){
      ...
      $msg = '';
      $target = "./images/News/".basename($_FILES['featured_image']['name']); 
...
<html lang="en">
  ...
  <body>
    ...
    <section id="new-article-screen">
      ...
      <form id="form-container" method="post" action="./News.php" enctype="multipart/form-data">
    ...
    <main>
      <aside>
        <a class="sidebar-items" href="./Highlights.php">
          <span>Highlights</span>
        </a>
        <a class="sidebar-items active"><span>News</span></a>
        ...
        <section class="articles">
          <article class="new-article" id="new-article-btn">
            ...
            <div class="new-article-content">
              <div class="new-article-text"><span>Add news article</span></div>
          ...
          <?php
                    ...
                    $sql = "SELECT * FROM news_information WHERE news_type='news'";
          ...
          <article class="article-items" href="">
            ...
            <img src="./images/News/<?= $row['Featured_Image']?>" class="article-img" />
            <div class="article-info">
              ...
              <div class="article-actions">
                ...
                <!-- <form style="display: inline;" action="./News.php" method="POST">
                  <button
                    id="delete-highlight"
                    type="submit"
                    name="delete_news"
          ...
          <!-- <article class="article-items" href="">
            ...
            <div class="article-info">
              <div class="dates">
                ...
                <div class="last-modified">Modified 3 days ago</div>
              </div>
              <div class="article-actions">
