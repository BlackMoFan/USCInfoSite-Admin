<?php
    ...
    if(isset($_POST['upload'])) {
        ...
        $target = "./documentFiles/Resolution/".basename($_FILES['new_file']['name']);
...
<body>
  ...
  <section id="new-file-form">
    ...
    <form action="./Resolution.php" method="post" id="file-form-container" enctype="multipart/form-data">
          ...
          <div class="list-items">
            <ul>
              <?php
                      ...
                      $sql = "SELECT * FROM transparency_reports WHERE report_type='Resolution'";
              ...
              <!-- <li>
                <span class="list-item-name">foo bar</span>
