...
<body>
  ...
  <section id="new-file-form">
    ...
    <form action="./MinutesMeeting.php" method="post" id="file-form-container" enctype="multipart/form-data">
  ...
  <main>
    <aside>
      <a class="sidebar-items" href="./AccomplishmentReport.php"
        ><span
          >Accomplishment <br />
          Report</span
        ></a
      ...
      <a class="sidebar-items active" href="./MinutesMeeting.php"
        >Minutes of the <br />
        Meeting</a
      >
          ...
          <div class="list-items">
            <ul>
              <?php
                      ...
                      $sql = "SELECT * FROM transparency_reports WHERE report_type='MinutesMeeting'";
              ...
              <!-- <li>
                <span class="list-item-name">10 minutes</span>
