...
<body>
  ...
  <section id="new-file-form">
    ...
    <form action="./Memorandum.php" method="post" id="file-form-container" enctype="multipart/form-data">
  ...
  <main>
    <aside>
      ...
      <a class="sidebar-items active">Memorandum</a>
          ...
          <div class="list-items">
            <ul>
              <?php
                      ...
                      $sql = "SELECT * FROM transparency_reports WHERE report_type='Memorandum'";
              ...
              <!-- <li>
                <span class="list-item-name">memorandumm</span>
