<?php
    ...
    if(isset($_POST['upload'])) {
        ...
        $target1 = "./images/College-based/logo/".basename($_FILES['organization_logo']['name']);
        $target2 = "./images/College-based/featured_image/".basename($_FILES['featured_image']['name']);

        // get all the submitted data from the form
        $organization_name = $_POST['organization_name'];
        $organization_number = random_num(11);
        $organization_category = 'college-based';
        ...
        // Move the uploaded image into the folder - images/College-based/logo
        ...
        // Move the uploaded image into the folder - images/College-based/featured_image/
...
<html lang="en">
  <head>
    ...
    />
    <title>USC Organizations Section - College-based</title>
  ...
  <body>
    ...
    <section id="new-org-screen">
      ...
      <form id="org-form-container" method="post" action="./CollegeBased.php" enctype="multipart/form-data">
    ...
    <main>
      <aside>
        <a class="sidebar-items" href="./UniversityBased.php"
          ><span>University-Based</span></a
        >
      ...
      <section id="news-list">
        ...
        <section class="articles">
          ...
          <?php
                    ...
                    $sql = "SELECT * FROM organizations WHERE organization_category='college-based'";
          ...
          <article class="article-items" href="">
            ...
            >
            <img src="./images/College-based/logo/<?= $row['organization_logo'] ?>" class="article-img" />
            <div class="article-info">
              ...
              <div class="article-actions">
                ...
                <!-- <form style="display: inline;" action="./CollegeBased.php" method="POST">
                  <button
                    id="delete-highlight"
                    type="submit"
                    name="delete_organization"
                    value="<?= $row["organization_number"] ?>"
                    onclick="confirm('Are you sure you want to delete the item <?= $row['organization_name'] ?>?')"
                  >
